...
class RoundProgress(QWidget):
    ...
    def __init__(self, t, parent=None):
        ...
        gradient.setColorAt(0, QColor(255, 255, 10))
        gradient.setColorAt(1, QColor(255, 201 ,14))
        gradient.setColorAt(1, QColor(255, 201 ,230))
    ...
    def paintEvent(self, event):
        ...
        # print(rect,type(rect),self.fsize, self.fsize, width-self.fsize*2, height-self.fsize*2)
